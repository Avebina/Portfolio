    ...
    <section className='intro-section'>
      ...
      <div className='CTAs'>
        ...
        <div className='socials'>
          <a href={"https://www.linkedin.com/in/abelkebede0/"} target="_blank" rel="noopener noreferrer">
            <FontAwesomeIcon icon={faLinkedin} size="2x" />
          </a>
          <a href={"https://github.com/avebina"} target="_blank" rel="noopener noreferrer">
